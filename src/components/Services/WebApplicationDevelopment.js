    ...
    <>
        ...
        <DivStyle1 >
          ...
          <DivStyle3>
            ...
            <div className="container" >
              <img width='100%' style={{ top: 0, left: 0, height: "300px" }} src={webAppDevImg} ></img>
        ...
        <DivStyle1 >
          ...
          <DivStyle2>
            ...
            <Card sx={cardStyle} style={{ paddingLeft: 30, paddingRight: 30, borderTopRightRadius: 30, borderBottomLeftRadius: 30 }} elevation={3}>
              <CardContent>
                <Typography variant="h6" style={{ marginBottom: 30, fontFamily: "nunito", color: Colors.MAIN_COLOR, marginTop: 15 }}>Web Application for your Business</Typography>
          ...
          {/* Ride Side */}
          <DivStyle3>
            <Card sx={cardStyle1} style={{ paddingLeft: 30, paddingRight: 30, borderTopRightRadius: 30, borderBottomLeftRadius: 30 }} elevation={3}>
              <CardContent>
                <Typography variant="h6" style={{ marginBottom: 30, fontFamily: "nunito", color: Colors.MAIN_COLOR, marginTop: 15, }}>Why to approach Netcom ?</Typography>
      ...
      <div style={{ width: "100%", marginTop: "5%" }}>
        ...
        <DivStyle1 style={{ flexDirection: "column" }}>
          <Typography variant="h4" style={{ display: "flex", margin: "0 auto", color: Colors.MAIN_COLOR }}>Web Application Development Services</Typography>
      ...
      <div style={{ width: "100%", marginTop: "5%" }}>
        {/* 67% middle of page */}
        <DivStyle1 style={{ flexDirection: "column" }}>
          <Typography variant="h4" style={{ display: "flex", margin: "0 auto", color: Colors.MAIN_COLOR }}>How We Work</Typography>

          <div style={{ display: "flex", justifyContent: "space-between", flexDirection: "row", marginTop: "7%", flexWrap: "wrap", gap: 10 }}>

            {howWeWork.map((obj) => (

              <ProductCards>
                <img src={obj.imageUrl} width="20%" />
                <Typography variant="h6" style={{ marginTop: 15, marginBottom: 15, color: Colors.MAIN_COLOR, fontWeight: "bold" }} >{obj.title}</Typography>
                <Typography variant="body1" style={{ textAlign: "justify", lineHeight: "26px" }} >{obj.text}</Typography>
      ...
      <div style={{ width: "100%" }}>
        ...
        <DivStyle1 style={{ flexDirection: "column" }}>
          ...
          <Typography variant="h4" style={{ display: "flex", margin: "0 auto", color: Colors.MAIN_COLOR }}>Web Application Development Stack</Typography>

          <Box sx={{ typography: "body1", marginTop: "7%", }}>
            <TabContext value={value}> <Box sx={{ borderBottom: 1, borderColor: "green", display: "flex", flexDirection: "row", justifyContent: "center", }} >
              <Tabs value={value} variant="scrollable" scrollButtons="auto" onChange={handleChange} TabIndicatorProps={{ style: { background: "green" } }} textColor="inherit" >
                <Tab sx={{ color: colorTextTab1, textTransform: "none" }} label={<Typography variant="h6" style={{ cursor: "pointer" }}>Languagess </Typography>} value="1" />
              ...
              <TabPanel value="1" >
                <div style={{ display: "flex", width: "100%", alignItems: "center", justifyContent: "center", marginTop: "5%", }} >
                  <fieldset style={{ width: "100%", border: "3px solid #4df752", fontSize: 20 }}>
                    <legend align="center">Languages</legend>

                    <div style={{ width: "100%", display: "flex", justifyContent: "center", flexWrap: "wrap", flexDirection: "column", alignItems: "center" }}>

                      <div style={{ textAlign: "center", width: "15%" }}>
                        <AnimationOnScroll animateIn="animate__zoomIn" animateOut='animate__zoomOut'  >
                          <img src={htmlLogo} width="70%" />
