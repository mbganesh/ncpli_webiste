                ...
                <Card sx={{ width: 450, height: 50 }} >
                    <CardContent>
                        <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
                            ...
                            <Typography color="text.primary">E-Content Development</Typography>
                        </Breadcrumbs>
                    </CardContent>
                </Card>
            </BreadcrumbStyle>
                ...
                <DivStyle1 >
                    ...
                    <DivStyle2>
                        ...
                        <Typography variant="body1" style={{ textAlign: "justify", marginTop: 20, fontFamily: "nunito" }}>
                            <span style={{ fontWeight: "bold" }}>Netcom E-Content </span> includes a comprehensive digital repository offering superior-quality content in Mathematics, Physics, Chemistry, Biology, Social Sciences, English Grammar, Business Studies, Economics and Accountancy. The portal has been designed especially for students of Classes I to XII and includes numerous visuals and animations to help increase student understanding and retention.
                        </Typography>
                    ...
                    <DivStyle3>
                        <div className="container" >
                            <img width='100%' style={{ top: 0, left: 0, height: "300px" }} src={eContentImg} ></img>
                        </div>
                    </DivStyle3>
                </DivStyle1>
            </div>
                ...
                <DivStyle1  >
                    <DivStyle2>
                        {eContentDevelopmentContents.titleParagraph1.map((obj) => (
                            <>
                                <Typography variant="h6" style={{ textAlign: "justify", marginTop: 20, fontFamily: "nunito", color: Colors.MAIN_COLOR }}> {obj.title} </Typography>
                                <Typography variant="body1" style={{ textAlign: "justify", marginTop: 20, fontFamily: "nunito" }}>{obj.paragraph} </Typography>
                            </>
                        ))}
                    </DivStyle2>
                ...
                <DivStyle1 >
                    <DivStyle2>
                        <Card sx={cardStyle} style={{ paddingLeft: 30, paddingRight: 30, borderTopRightRadius: 30, borderBottomLeftRadius: 30 }} elevation={3}>
                            <CardContent>
                                <Typography variant="h6" style={{ marginBottom: 30, fontFamily: "nunito", color: Colors.MAIN_COLOR, marginTop: 15 }}>Storyboard:</Typography>

                                <Typography variant="body1" style={{ textAlign: "justify", marginTop: 20, fontFamily: "nunito" }}>
                                    The storyboard is based on the Curriculum Specification of the related subject and should use the mapping, content script etc.
                                </Typography>
                    ...
                    <DivStyle3>
                        <Card sx={cardStyle} style={{ paddingLeft: 30, paddingRight: 30, borderTopRightRadius: 30, borderBottomLeftRadius: 30 }} elevation={3}>
                            <CardContent>
                                <Typography variant="h6" style={{ marginBottom: 30, fontFamily: "nunito", color: Colors.MAIN_COLOR, marginTop: 15, }}>Steps in development of econtent module: </Typography>
