        ...
        return [
            {
                ...
                titleName: "Languages",
                legend: "Languages",
                content: [{ icon: htmlLogo, name: "HTML" }, { icon: cssLogo, name: "CSS" }, { icon: jsLogo, name: "JavaScript" }]
            },
            {
                id: 2,
                titleName: "Front-end",
                legend: "Frameworks & CSS",
                content: [{ icon: reactLogo, name: "React JS" }, { icon: muiLogo, name: "MUI" }]
            },
            {
                id: 3,
                titleName: "Back-end",
                legend: "Languages & Framework",
                content: [{ icon: nodeLogo, name: "Node JS" }, { icon: expressLogo, name: "Express JS" }]
            },
            {
                id: 4,
                titleName: "Database",
                legend: "Storage & Cloud Storage",
                content: [{ icon: mongoLogo, name: "MongoDB" }, { icon: AWSLogo, name: "AWS" }]
            }
        ];
    }, []);
        ...
        <>
                ...
                <Card sx={{ width: 480, height: 50 }} >
                    <CardContent>
                        <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
                            ...
                            <Typography color="text.primary">Mobile Application Development</Typography>
            ...
            <div style={{ width: "100%", marginTop: "5%", }}>
                ...
                <DivStyle1>
                    {/* Left Side */}
                    <DivStyle2>
                        <Typography variant="body1" style={{ textAlign: "justify", marginTop: 20 }}>
                            Mobile App Development is the process of developing and helping to implement apps that run on <span style={{ fontWeight: "bold" }}>Android</span>  and <span style={{ fontWeight: "bold" }}> iOS</span> Powered Mobile devices and a typical mobile application utilizes a network connection to work with remote computing resources.
                        </Typography>
                        <Typography variant="body1" style={{ textAlign: "justify", marginTop: 7 }}>
                            Many of you will think that ―Our business style doesn't need an app to sell products to our clients! And maybe that would have been the case in the past. But if you want to prepare for the future and start seeing the massive benefits right out the gate, you'll definitely need a mobile app for your business development.
                        </Typography>
                    </DivStyle2>
                    {/* Ride Side */}
                    <DivStyle3>
                        ...
                        <div className="container" >
                            <img width='100%' style={{ top: 0, left: 0, height: "300px" }} src={mobFirstScreen} ></img>
                        </div>
                        {/* React Player Div */}
                    </DivStyle3>
                </DivStyle1>
            ...
            <div style={{ width: "100%", marginTop: 25, marginBottom: 50 }}>
                <DivStyle1 style={{ display: "flex", flexDirection: "column" }} >
                    <Typography variant="h6" style={{ textAlign: "justify", marginTop: 7, color: Colors.MAIN_COLOR }}> What does a Mobile App actually do? </Typography>
                    <Typography variant="body1" style={{ textAlign: "justify", marginTop: 7 }}>
                        Mobile Applications would permit the users to have functional access to any products, information, process or services that they would demand in real-time.
                        <br />It enables the business to send notifications about changes in products and services or something new.
                    </Typography>
                </DivStyle1>
            </div>
            ...
            <MobAppDevStepsSection>
                    ...
                    {mobAppDevContents.appProcess.map((obj) => (
                            ...
                            <CardContent >
                                <Typography variant="h6" style={{ color: Colors.MAIN_COLOR }}  >{obj.title}</Typography>
                                <Typography variant="body1" style={{ marginTop: 10, textAlign: "justify" }} >{obj.text}</Typography>
                            </CardContent>
                            </Card>
            ...
            <div style={{ width: "100%", marginTop: 25, }}>
                <DivStyle1  >
                    <DivStyle2><Typography variant="h6" style={{ textAlign: "justify", marginTop: 7, color: Colors.MAIN_COLOR }}> What you can achieve by that? </Typography>
                        <ul>
                            <Typography variant="body1" style={{ textAlign: "justify", marginTop: 7, fontFamily: "nunito" }}>
                                Through that regular contact with your target clients, you're fostering their trust.
                            </Typography>
                            <Typography variant="body1" style={{ textAlign: "justify", marginTop: 2, fontFamily: "nunito" }}>
                                The more your clients trust you, the more likely they'll be to listen to later sales pitches and would commit to your products and services.
                            </Typography>
                            <Typography variant="body1" style={{ textAlign: "justify", marginTop: 2, fontFamily: "nunito" }}>
                                Netcom will create you a highly customized, client-friendly mobile application for making all your business operations and promotions easier.
                            </Typography>
                        </ul>
                    </DivStyle2>

                    <DivStyle3><Typography variant="h6" style={{ textAlign: "justify", marginTop: 7, color: Colors.MAIN_COLOR }}> Our Developing Strategies for Brand & Online Presence </Typography>
                        <ul>
                            <Typography variant="body1" style={{ textAlign: "justify", marginTop: 7 }}>
                                Android Mobile & Tablet Application Development
                            </Typography>
                            <Typography variant="body1" style={{ textAlign: "justify", marginTop: 2 }}>
