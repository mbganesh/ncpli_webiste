...
import ChoiceBasedQuestion from "../../images/products/GilGal/ChoiceBasedQuestion.svg";
import ClearDoubts from "../../images/products/GilGal/ClearDoubts.svg";
import DeviceSupports from "../../images/products/GilGal/DeviceSupports.svg";
import LanguageSupport from "../../images/products/GilGal/LanguageSupport.svg";
import LearnFromAnywhere from "../../images/products/GilGal/LearnFromAnywhere.svg";
import LearnVideoClass from "../../images/products/GilGal/LearnVideoClass.svg";
import ModalQuestionPaper from "../../images/products/GilGal/ModalQuestionPaper.svg";
import QuestionAndAnswer from "../../images/products/GilGal/QuestionAndAnswer.svg";
...
const MyCard = styled("div")(({ theme }) => ({
  ...
  "&:hover": {
    boxShadow: `15px 15px 15px #8c8c8c,
    -15px -15px 15px #f2f2f2`,
  },
  [theme.breakpoints.down("md")]: {
    width: "100%",
  },
  ...
  const ServicesList = [
    ...
    },
    {
      ...
      content: [
        ...
        "The students who are looking for a single place to get the Subject.",
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
      ],
    },
    {
