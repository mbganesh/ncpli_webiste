    ...
    <>
      ...
      <div style={{ width: "100%", marginTop: 25 }}>
        ...
        <DivStyle1>
          ...
          {/* Ride Side */}
          <DivStyle3>
            <Typography variant="h6" style={{ marginBottom: 10,fontWeight:"bold", fontFamily: "nunito", color:Colors.MAIN_COLOR }}>Smart Classroom Teaching video</Typography>
      ...
      <div style={{ width: "100%", marginTop: 25 }}>
        ...
        <DivStyle1>
          ...
          <DivStyle3>
            <Typography variant="h6" style={{ marginBottom: 10,fontWeight:"bold",  fontFamily: "nunito", color:Colors.MAIN_COLOR }}>Methodology</Typography>
        ...
        <DivStyle1>
          ...
          <DivStyle2>
            ...
            <Card elevation={4} sx={cardStyle}>
              <CardContent>
                <Typography variant="h6" style={{ margin:10,fontWeight:"bold",  fontFamily: "nunito", color:Colors.MAIN_COLOR }}>Our Smart Classroom Projects</Typography>
          ...
          <DivStyle3>
            <Card elevation={4} sx={cardStyle}>
              <CardContent>
                <Typography variant="h6" style={{ margin:10,fontWeight:"bold",  fontFamily: "nunito",color:Colors.MAIN_COLOR }}>Highlights of Netcom Smart Class Room</Typography>
      ...
      <div style={{ width: "100%", marginTop: 35, }}>
        <DivStyle1 style={{ display: "flex", flexDirection: "column" }}>
          <Typography variant="h6" style={{ marginBottom: 10,fontWeight:"bold",  fontFamily: "nunito", color:Colors.MAIN_COLOR }}>Passion for Learning</Typography>
